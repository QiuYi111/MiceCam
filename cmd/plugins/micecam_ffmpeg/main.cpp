...
static void print_usage(const char* prog) {
    std::cerr << "Usage: " << prog << " [--port=PORT]\n\n"
              << "Options:\n"
              << "  --port=PORT       gRPC listen port (default: 50051, env: MiceCAM_PLUGIN_PORT)\n"
...
int main(int argc, char* argv[]) {
    ...
    spdlog::info("MiceCam FFmpeg Plugin v1.0.0 starting on port {}", port);
    ...
    // Build server
    micecam::plugin::FFmpegPluginServer service;
