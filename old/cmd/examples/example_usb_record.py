"""
MiceCam Example: USB Camera Recording & Auto-Decoding
Uses FFmpeg backend to record MJPEG from a USB camera.
"""
import sys
import os
import time
...
def main():
    parser = argparse.ArgumentParser(description="MiceCam USB Recording Example")
    parser.add_argument("--out", type=str, default="recordings", help="Output directory")
    parser.add_argument("--session", type=str, default="usb_recording", help="Session name")
    parser.add_argument("--width", type=int, default=3840, help="Width (e.g., 3840 for 4K)")
    parser.add_argument("--height", type=int, default=2160, help="Height (e.g., 2160 for 4K)")
    ...
    try:
        # Create pipeline for USB (FFmpeg)
